...
def main(dataPath):
    ...
    fig, axForce = plt.subplots(figsize=(6, 8), facecolor='w', ncols=1)
    ...
    f_10kc, s_10kc = (
        data['10% WSt kCar force to break'],
        data['10% WSt kCar height to break'])
    ...
    plotCompression(
        ...
        ax=axForce, x=s_10kc, y=f_10kc[0] / (30/1000), axisColor='k',
    ...
    plt.subplots_adjust(wspace=0.175, top=0.940, bottom=0.08, left=0.12, right=0.96)
    # plt.tight_layout()
    plt.show()
